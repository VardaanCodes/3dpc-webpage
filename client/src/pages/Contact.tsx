  ...
  const faqItems = [
    {
      ...
      answer: "Processing times vary from 1-7 days depending on complexity and queue length. Check the Guidelines page for detailed estimates."
    },
    {
      question: "Can I use my own filament?",
      answer: "Yes! Check the 'provide own filament' option when submitting your request. You'll need to deliver it before printing begins."
    },
    {
      question: "What if my print fails?",
      answer: "We'll notify you with suggestions for improvement and allow resubmission. Common issues include overhangs, thin walls, or unsupported features."
    },
    {
      question: "Can I cancel my print request?",
      answer: "Yes, you can request cancellation through this contact form. Include your order ID for faster processing."
    },
    {
      question: "How do I know when my print is ready?",
      answer: "You'll receive email notifications at each stage: approval, start, completion, or if issues arise."
    }
  ];
  ...
  return (
    <div className="space-y-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Get help with your 3D printing requests and technical issues.</p>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Engineering Building, Room 101</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white">Operating Hours</p>
                    <p className="text-sm text-gray-400">Mon-Fri: 9AM-5PM</p>
                    <p className="text-xs text-gray-500">Closed weekends and holidays</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">For urgent print failures only</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="file-upload">File Upload Problem</SelectItem>
                          <SelectItem value="account">Account Access</SelectItem>
                          <SelectItem value="cancellation">Cancel Print Request</SelectItem>
                          <SelectItem value="rush">Rush Order Request</SelectItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-300">Order ID (if applicable)</FormLabel>
                      <FormControl>
                        <Input
            ...
            <div className="mt-6 p-4 bg-slate-900 rounded-lg border border-slate-700">
              ...
              <p className="text-xs text-gray-400">
                ...
                For urgent issues during operating hours, consider visiting our location directly.
              </p>
            </div>
          </CardContent>
        </Card>
